...
if(!abonerol) return message.channel.send(`Abone rolü ayarlanmamış!`)
  ...
  .setTitle(`Abone Rolü Verildi! <a:ramiz_onay2:798554530375270471>`)
  .addField(`<a:xr_hype:798569692335177769> Abone Rolünü Veren Kişi:`, `${message.author.tag}`, true)
  .addField(`<a:xr_hype:798569692335177769> Abone Rolü Verilen Kişi`, `${user}`, true)
  .setColor(`GOLD`)
